...
<body>
	<nav class="navbar navbar-expand-md navbar-light bg-warning"> <a
		class="navbar-brand" href="/userpanel/">Welcome to Food Mart </a>
	...
	<div class="collapse navbar-collapse" id="collapsibleNavbar">
		...
		<ul class="nav navbar-nav ml-auto">
			<li class="nav-item"><a class="nav-link"
				href="http://localhost:8080/menuitems/">Admin Panel</a></li>
			<li class="nav-item"><a class="nav-link" href="/userpanel/">
					User Panel</a></li>
		</ul>
	</div>
	</nav>
			...
			<tbody>
				<c:forEach items="${list}" var="emp">
					<tr>
						...
						<td><a href="cart/1/${emp.id}"></a>

							<form method="post" action="cart/1/${emp.id}" class="inline">
