...
<body><nav class="navbar navbar-expand-md navbar-light bg-warning"> <a
		class="navbar-brand" href="#">Add MenuItem </a>
  ...
  <form:form  method="post" modelAttribute="add" class="shadow-lg p-4 text-black">
  ...
  <div class="form-group" >
    ...
    <form:input type="text" class="form-control" path="price" required="true"/>
  </div>
   <div class="form-group" >
    <form:label path="actv">Active Status</form:label>
    <form:input type="text" class="form-control" path="actv" required="true"/>
  </div>
     <div class="form-group" >
    <form:label path="dateOfLaunch">Date of Launch</form:label>
    <form:input type="text" class="form-control" path="dateOfLaunch" required="true"/>
  </div>
 	     <div class="form-group" >
    <form:label path="category">Category</form:label>
    <form:input type="text" class="form-control" path="category" required="true"/>
  </div>
 	<div class="form-group" >
    <form:label path="freeDelivery">Free Delivery Option</form:label>
    <form:input type="text" class="form-control" path="freeDelivery" required="true"/>
  </div>
